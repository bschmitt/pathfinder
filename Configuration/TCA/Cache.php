...
$TCA['tx_pathfinder_domain_model_cache'] = array(
	'ctrl'      => $TCA['tx_pathfinder_domain_model_cache']['ctrl'] ,
	'interface' => array(
		'showRecordFieldList' => 'path'
	) ,
	'types'     => array(
		'0' => array('showitem' => 'path') ,
	) ,
	'palettes'  => array(
		'1' => array('showitem' => '')
	) ,
	'columns'   => array(
		...
		'dependencies' => array(
			'exclude' => 0 ,
			'label'   => 'LLL:EXT:pathfinder/Resources/Private/Language/locallang_db.xml:dependencies' ,
			'config'  => array(
				'type' => 'input'
			)
		) ,
